...
export function StripPrinterStrip({
  setDraggedStrip,
  handleStripInsert,
  handleDeletePrinterStrip,
  selectedIndex,
  setSelectedIndex,
}: Props) {
  ...
  return (
    <>
      <Grid container>
        ...
        <Grid textAlign={'left'}>
          {selectedIndex < printerStrips.length && (
            <BayItem
              abstractStripData={printerStrips[selectedIndex]}
      ...
      <p style={{ marginTop: '-50px' }}>
        {selectedIndex + 1}/{printerStrips.length}
      </p>
