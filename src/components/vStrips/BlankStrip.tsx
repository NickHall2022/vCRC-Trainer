  ...
  return (
    <div>
      <div style={{ position: 'absolute', left: '5px', top: '5px' }}>
        <ControlledInput
          className={'stripTextInputSmall'}
          disabled={stripData.bayName === 'printer'}
          maxLength={8}
          value={stripData.callsign}
          onChange={(event) => handleTextInput('callsign', event.target.value)}
        ></ControlledInput>
        <br></br>
        <ControlledInput
          className={'stripTextInputSmall'}
      ...
      <div style={{ position: 'absolute', left: '125px' }}>
        ...
        <ControlledInput
          ...
          disabled={stripData.bayName === 'printer'}
          maxLength={7}
          value={stripData.altitude}
          onChange={(event) => handleTextInput('altitude', event.target.value)}
        ></ControlledInput>
      </div>
      <div style={{ position: 'absolute', left: '173px', top: '5px' }}>
        <ControlledInput
          ...
          disabled={stripData.bayName === 'printer'}
          maxLength={4}
          value={stripData.departure}
          onChange={(event) => handleTextInput('departure', event.target.value)}
        ></ControlledInput>
      </div>
      <div style={{ position: 'absolute', left: '248px', top: '5px' }}>
        <ControlledInput
          ...
          disabled={stripData.bayName === 'printer'}
          maxLength={15}
          value={stripData.route}
          onChange={(event) => handleTextInput('route', event.target.value)}
        ></ControlledInput>
        <br></br>
        <ControlledInput
          className={'stripTextInputSmall'}
      ...
      <input
        ...
        style={{ position: 'absolute', left: '452px', outline: 'none' }}
      ></input>
      <input
        type="text"
        className={'stripTextInput'}
        ...
        style={{ position: 'absolute', left: '515px', outline: 'none' }}
      ></input>
    </div>
  );
}
