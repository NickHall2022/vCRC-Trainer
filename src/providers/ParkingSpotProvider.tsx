...
const GA_SPOTS: PartialParkingSpot[] = [
    {x: 62.5, y: 34, rotation: 0, pushbackIntoRamp: false, location: "north ramp"},
    {x: 62.8, y: 32, rotation: 180, pushbackIntoRamp: false, location: "north ramp"},
    {x: 62.1, y: 30, rotation: 0, pushbackIntoRamp: false, location: "north ramp"},
    {x: 62.4, y: 28, rotation: 180, pushbackIntoRamp: false, location: "north ramp"},
    {x: 62.7, y: 26, rotation: 0, pushbackIntoRamp: false, location: "north ramp"},
]

const TEC_SPOTS: PartialParkingSpot[] = [
    {x: 61, y: 47.5, rotation: 70, pushbackIntoRamp: false, location: "gate 1B", airline: "KAP"},
    {x: 63, y: 46.5, rotation: 170, pushbackIntoRamp: false, location: "gate 1A", airline: "KAP", taxiInstruction: "Runway 29, taxi via C, A, cross runway 36"},
    {x: 63, y: 22, rotation: 0, pushbackIntoRamp: false, location: "north ramp", taxiInstruction: "Runway 29, taxi via C, A, cross runway 36"},
    {x: 63, y: 20, rotation: 180, pushbackIntoRamp: false, location: "north ramp", taxiInstruction: "Runway 29, taxi via C, A, cross runway 36"},
    {x: 63, y: 18, rotation: 0, pushbackIntoRamp: false, location: "north ramp", taxiInstruction: "Runway 29, taxi via C, A, cross runway 36"},
    {x: 63, y: 16, rotation: 180, pushbackIntoRamp: false, location: "north ramp", taxiInstruction: "Runway 29, taxi via C, A, cross runway 36"},
    {x: 75, y: 37, rotation: 270, pushbackIntoRamp: false, location: "cargo ramp", airline: "FDX", taxiInstruction: "Runway 29, taxi via G, join runway 18, A"},
    {x: 76.5, y: 37.5, rotation: 90, pushbackIntoRamp: false, location: "cargo ramp", airline: "FDX", taxiInstruction: "Runway 29, taxi via G, join runway 18, A"},
    {x: 78, y: 37, rotation: 270, pushbackIntoRamp: false, location: "cargo ramp", airline: "WIG", taxiInstruction: "Runway 29, taxi via G, join runway 18, A"},
    {x: 79.5, y: 37.5, rotation: 90, pushbackIntoRamp: false, location: "cargo ramp", airline: "WIG", taxiInstruction: "Runway 29, taxi via G, join runway 18, A"},
]

function calcPushbackLocation(x: number, y: number, rotation: number){
    const angleAsRadians = rotation * Math.PI / 180;
    return { x: x - 4 * Math.cos(angleAsRadians), y: y + 4 * Math.sin(angleAsRadians)};
}
